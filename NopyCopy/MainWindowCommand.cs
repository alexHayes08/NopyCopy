...
namespace NopyCopyV2
{
    ...
    internal sealed class MainWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("58b4086a-716f-4429-b7d8-ac41899e9507");
        ...
        private MainWindowCommand(Package package)
        {
            ...
            var solutionService = ServiceProvider.GetService(typeof(IVsSolution)) as IVsSolution;
            var solutionEventsService = ServiceProvider.GetService(typeof(IVsSolutionEvents)) as IVsSolutionEvents;
            
            var projects = solutionService.GetProjects();

            if (IsStandardNopProject(solutionService))
            {
                // TODO: 
            }
        }
